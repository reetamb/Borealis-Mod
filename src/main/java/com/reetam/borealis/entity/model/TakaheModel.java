...
public class TakaheModel<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition beak = partdefinition.addOrReplaceChild("beak", CubeListBuilder.create().texOffs(21, 0).addBox(-1.5F, -9.9543F, -12.8155F, 3.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 19.0F, 4.0F, 0.3491F, 0.0F, 0.0F));

		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(44, 0).addBox(-2.5F, -12.0F, -7.2F, 5.0F, 5.0F, 5.0F, new CubeDeformation(0.0F))
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, 1.2182F, 0.3451F, 6.0F, 7.0F, 9.0F, new CubeDeformation(0.0F))
		...
		PartDefinition rightLeg = partdefinition.addOrReplaceChild("rightLeg", CubeListBuilder.create().texOffs(0, 0).addBox(-2.75F, 1.0F, -2.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(15, 16).addBox(-3.75F, 5.0F, -4.95F, 4.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 19.0F, 1.0F));

		PartDefinition leftLeg = partdefinition.addOrReplaceChild("leftLeg", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(-1.25F, 0.0F, -2.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false)
