...
public class HelixFoliagePlacer extends FoliagePlacer {
    ...
    public static final Codec<HelixFoliagePlacer> field_236790_a_ = RecordCodecBuilder.create((p_242836_0_) -> {
    ...
    protected void func_230372_a_(IWorldGenerationReader reader, Random random, BaseTreeFeatureConfig config, int p_230372_4_, FoliagePlacer.Foliage foliage, int foliageBottomHeight, int p_230372_7_, Set<BlockPos> p_230372_8_, int foliageTopHeight, MutableBoundingBox boundingBox) {
        ...
        for(int l = foliageTopHeight; l >= -foliageBottomHeight; --l) {
            this.func_236753_a_(reader, random, config, nextLeaf(blockpos, i), 1, p_230372_8_, l, foliage.func_236765_c_(), boundingBox);
            this.func_236753_a_(reader, random, config, nextLeaf(blockpos, i).down(), 0, p_230372_8_, l, foliage.func_236765_c_(), boundingBox);
            i++;
        }
        this.func_236753_a_(reader, random, config, blockpos, 0, p_230372_8_, foliageTopHeight+1, foliage.func_236765_c_(), boundingBox);
    }
