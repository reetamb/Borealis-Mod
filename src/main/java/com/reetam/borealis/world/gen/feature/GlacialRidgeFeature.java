...
public class GlacialRidgeFeature extends Feature<ColumnConfig> {
    private static final ImmutableList<Block> field_236245_a_ = ImmutableList.of(Blocks.WATER);
    ...
    private static boolean func_236247_a_(IWorld p_236247_0_, int p_236247_1_, BlockPos p_236247_2_) {
        ...
        return blockstate.isAir() || blockstate.isIn(Blocks.WATER) && p_236247_2_.getY() <= p_236247_1_;
    }
}
