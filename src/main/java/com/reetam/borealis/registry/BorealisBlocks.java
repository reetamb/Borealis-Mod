...
public class BorealisBlocks {
    ...
    public static final RegistryObject<Block> CLOUD = registerBlock("cloud", () -> new CloudBlock(AbstractBlock.Properties.of(Material.WEB).sound(SoundType.WOOL).strength(0.4F).noCollission().harvestTool(ToolType.SHOVEL)));
