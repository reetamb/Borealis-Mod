...
public class BorealisBlocks {
    ...
    public static final RegistryObject<WoodButtonBlock> SOAPSTONE_BUTTON = registerBlock("soapstone_button", () -> new WoodButtonBlock(BlockBehaviour.Properties.copy(BorealisBlocks.SOAPSTONE_TILES.get()).noOcclusion().noCollission()));
    public static final RegistryObject<PressurePlateBlock> SOAPSTONE_PRESSURE_PLATE = registerBlock("soapstone_pressure_plate", () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, BlockBehaviour.Properties.copy(BorealisBlocks.SOAPSTONE_TILES.get()).noOcclusion().noCollission()));
    ...
    public static final RegistryObject<LiquidBlock> HOT_SPRING_WATER_BLOCK = BLOCKS.register("hot_spring_water", () -> new HotSpringWaterBlock(
            BorealisFluids.HOT_SPRING_WATER_SOURCE, BlockBehaviour.Properties.of(Material.WATER)));
    ...
    public static final RegistryObject<SaplingBlock> BRUMAL_SAPLING = registerBlock("brumal_sapling", () -> new BorealisSaplingBlock(new BrumalTreeGrower()));
    ...
    public static final RegistryObject<FenceGateBlock> BRUMAL_FENCE_GATE = registerBlock("brumal_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.copy(BorealisBlocks.BRUMAL_PLANKS.get()).noOcclusion()));
    public static final RegistryObject<DoorBlock> BRUMAL_DOOR = registerBlock("brumal_door", () -> new DoorBlock(BlockBehaviour.Properties.copy(BorealisBlocks.BRUMAL_PLANKS.get()).noOcclusion()));
    public static final RegistryObject<TrapDoorBlock> BRUMAL_TRAPDOOR = registerBlock("brumal_trapdoor", () -> new TrapDoorBlock(BlockBehaviour.Properties.copy(BorealisBlocks.BRUMAL_PLANKS.get()).noOcclusion()));
    public static final RegistryObject<WoodButtonBlock> BRUMAL_BUTTON = registerBlock("brumal_button", () -> new WoodButtonBlock(BlockBehaviour.Properties.copy(BorealisBlocks.BRUMAL_PLANKS.get()).noOcclusion().noCollission()));
    public static final RegistryObject<PressurePlateBlock> BRUMAL_PRESSURE_PLATE = registerBlock("brumal_pressure_plate", () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, BlockBehaviour.Properties.copy(BorealisBlocks.BRUMAL_PLANKS.get()).noOcclusion().noCollission()));
    ...
    public static final RegistryObject<SaplingBlock> FROSTFIR_SAPLING = registerBlock("frostfir_sapling", () -> new BorealisSaplingBlock(new FrostfirTreeGrower()));
    ...
    public static final RegistryObject<FenceGateBlock> FROSTFIR_FENCE_GATE = registerBlock("frostfir_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.copy(BorealisBlocks.FROSTFIR_PLANKS.get()).noOcclusion()));
    public static final RegistryObject<DoorBlock> FROSTFIR_DOOR = registerBlock("frostfir_door", () -> new DoorBlock(BlockBehaviour.Properties.copy(BorealisBlocks.FROSTFIR_PLANKS.get()).noOcclusion()));
    public static final RegistryObject<TrapDoorBlock> FROSTFIR_TRAPDOOR = registerBlock("frostfir_trapdoor", () -> new TrapDoorBlock(BlockBehaviour.Properties.copy(BorealisBlocks.FROSTFIR_PLANKS.get()).noOcclusion()));
    public static final RegistryObject<WoodButtonBlock> FROSTFIR_BUTTON = registerBlock("frostfir_button", () -> new WoodButtonBlock(BlockBehaviour.Properties.copy(BorealisBlocks.FROSTFIR_PLANKS.get()).noOcclusion().noCollission()));
    public static final RegistryObject<PressurePlateBlock> FROSTFIR_PRESSURE_PLATE = registerBlock("frostfir_pressure_plate", () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, BlockBehaviour.Properties.copy(BorealisBlocks.FROSTFIR_PLANKS.get()).noOcclusion().noCollission()));
    ...
    public static final RegistryObject<SaplingBlock> SACCHARINE_SAPLING = registerBlock("saccharine_sapling", () -> new BorealisSaplingBlock(new SaccharineTreeGrower()));
    ...
    public static final RegistryObject<FenceGateBlock> SACCHARINE_FENCE_GATE = registerBlock("saccharine_fence_gate", () -> new FenceGateBlock(BlockBehaviour.Properties.copy(BorealisBlocks.FROSTFIR_PLANKS.get()).noOcclusion()));
    public static final RegistryObject<DoorBlock> SACCHARINE_DOOR = registerBlock("saccharine_door", () -> new DoorBlock(BlockBehaviour.Properties.copy(BorealisBlocks.FROSTFIR_PLANKS.get()).noOcclusion()));
    public static final RegistryObject<TrapDoorBlock> SACCHARINE_TRAPDOOR = registerBlock("saccharine_trapdoor", () -> new TrapDoorBlock(BlockBehaviour.Properties.copy(BorealisBlocks.FROSTFIR_PLANKS.get()).noOcclusion()));
    public static final RegistryObject<WoodButtonBlock> SACCHARINE_BUTTON = registerBlock("saccharine_button", () -> new WoodButtonBlock(BlockBehaviour.Properties.copy(BorealisBlocks.FROSTFIR_PLANKS.get()).noOcclusion().noCollission()));
    public static final RegistryObject<PressurePlateBlock> SACCHARINE_PRESSURE_PLATE = registerBlock("saccharine_pressure_plate", () -> new PressurePlateBlock(PressurePlateBlock.Sensitivity.EVERYTHING, BlockBehaviour.Properties.copy(BorealisBlocks.FROSTFIR_PLANKS.get()).noOcclusion().noCollission()));

    public static final RegistryObject<Block> KYANITE_ORE = registerBlock("kyanite_ore", () -> new Block(BlockBehaviour.Properties.copy(Blocks.EMERALD_ORE)));
    ...
    public static final RegistryObject<Block> CLOUD = registerBlock("cloud", () -> new CloudBlock(BlockBehaviour.Properties.of(Material.WEB).sound(SoundType.WOOL).strength(0.4F).noCollission().requiresCorrectToolForDrops()));
    ...
    public static void registerAxeStrips() {
        ...
        AxeItem.STRIPPABLES.put(BRUMAL_LOG.get(), STRIPPED_BRUMAL_LOG.get());
        AxeItem.STRIPPABLES.put(BRUMAL_WOOD.get(), STRIPPED_BRUMAL_WOOD.get());
        AxeItem.STRIPPABLES.put(FROSTFIR_LOG.get(), STRIPPED_FROSTFIR_LOG.get());
        AxeItem.STRIPPABLES.put(FROSTFIR_WOOD.get(), STRIPPED_FROSTFIR_WOOD.get());
        AxeItem.STRIPPABLES.put(SACCHARINE_LOG.get(), STRIPPED_SACCHARINE_LOG.get());
        AxeItem.STRIPPABLES.put(SACCHARINE_WOOD.get(), STRIPPED_SACCHARINE_WOOD.get());
    }

    public static void registerHoeTills() {
        HoeItem.TILLABLES = Maps.newHashMap(HoeItem.TILLABLES);

        HoeItem.TILLABLES.put(PERMAFROST_RUBBLE.get(), Pair.of(HoeItem::onlyIfAirAbove, HoeItem.changeIntoState(BorealisBlocks.PERMAFROST.get().defaultBlockState())));
    }
